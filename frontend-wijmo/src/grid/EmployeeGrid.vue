<template>
    <div style="max-height:80vh;">
        ...
        >
            <wj-flex-grid-filter :filterColumns="['userId','rankId','departmentId','employeeUser','phoneNo','startDate','managerYn','employeeUser',]" />
            ...
            <wj-flex-grid-column binding="startDate" header="startDate" width="2*" :isReadOnly="true" align="center" />
            <wj-flex-grid-column binding="managerYn" header="managerYn" width="2*" :isReadOnly="true" align="center" />
